...
// ==============================|| LOGO SVG - TSX WITH NAMED EXPRESSIONS ||============================== //
...
const LogoMain = ({ reverse }: LogoMainProps): JSX.Element => {
  ...
  const themeVars = (theme as any).vars || theme.palette;

  // Named Expressions para Colores (facilita el mantenimiento)
  ...
  const colorBlack = theme.vars?.palette.common.black ?? theme.palette.common.black;
